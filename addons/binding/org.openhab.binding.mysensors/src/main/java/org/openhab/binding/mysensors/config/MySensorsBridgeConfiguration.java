...
public class MySensorsBridgeConfiguration {
    ...
    public String toString() {
        return "MySensorsBridgeConfiguration [serialPort=" + serialPort + ", ipAddress=" + ipAddress 
                + ", tcpPort=" + tcpPort + ",brokerName=" + brokerName + ",  topicSubscribe="+ topicSubscribe + ", topicPublish=" 
                + topicPublish + ", sendDelay=" + sendDelay + ", baudRate=" + baudRate + ", imperial=" + imperial + ", skipStartupCheck="
