 ...
 *
 */
public class MySensorsChildSAirQuality extends MySensorsChild {

    private Logger logger = LoggerFactory.getLogger(getClass());
    
    public MySensorsChildSAirQuality(int childId) {
        super(childId);
        setPresentationCode(MySensorsMessageSubType.S_AIR_QUALITY);
        try {
