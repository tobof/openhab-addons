 ...
 */
@NonNullByDefault
public class MySensorsVariableVHvacSetpointCool extends MySensorsVariable {

    public MySensorsVariableVHvacSetpointCool() {
        super(MySensorsMessageSubType.V_HVAC_SETPOINT_COOL);
    }
}
